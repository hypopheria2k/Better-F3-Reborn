    ...
    public List<InfoLine> getLines() {
        ...
        if (mc.objectMouseOver != null && mc.objectMouseOver.typeOfHit == RayTraceResult.Type.ENTITY) {
            ...
            if (entity instanceof EntityAgeable) {
                ...
                if (ageTicks < 0) {
                    ...
                    lines.add(new InfoLine("Growth: ", getProgressBar(progress) + String.format(" %.1f%%", progress), 0x55FFFF));
        ...
        if (mc.objectMouseOver != null && mc.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK) {
            ...
            if (state.getBlock() instanceof BlockCrops) {
                ...
                if (age < maxAge) {
                    // Fortschritt & Stufen
                    lines.add(new InfoLine("Crop: ", getProgressBar(progress) + String.format(" %d/%d", age, maxAge), 0x55FF55));
                    ...
                    lines.add(new InfoLine("Light: ", light + (light <= 7 ? " (Too Dark!)" : " (OK)"), lightColor));
                    ...
                    lines.add(new InfoLine("Est. Time: ", "~" + formatTime(totalRemainingTicks), 0xAAAAAA));
                } else {
                    lines.add(new InfoLine("Status: ", "READY TO HARVEST", 0xFF55FF));
                }
            }
        }
        return lines;
